...
Системный промпт задаёт жёсткий формат вывода \texttt{<think>...</think>\allowbreak<answer>...</answer>}, в котором блок \texttt{<answer>} содержит JSON-массив рёбер графа рассуждения и финальную метку.
